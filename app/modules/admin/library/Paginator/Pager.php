...
namespace ZPhal\Modules\Admin\Library\Paginator;

/**
 * ZPhal\Modules\Admin\Library\Paginator\Pager
...
class Pager implements \IteratorAggregate, \Countable
{
     ...
     *
     */
    public function __construct(\Phalcon\Paginator\AdapterInterface $adapter, array $options = [])
    {
    ...
    protected function getRangeClass()
    {
        if (!array_key_exists('rangeClass', $this->options)) {
            $this->options['rangeClass'] = 'ZPhal\Modules\Admin\Library\Paginator\Pager\Range\Sliding';
        }
